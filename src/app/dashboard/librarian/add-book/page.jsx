...
export default function AddBookPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ২. আমাদের নিজস্ব ব্যাকএন্ড (API)-এ ডাটা পাঠানো
      const bookData = {
        title,
        author,
        description,
        ...
        category,
        imageUrl,
        // স্ট্যাটাস আমরা ব্যাকএন্ড থেকে ডিফল্ট সেট করব সিকিউরিটির জন্য, 
        // তবে চাইলে এখান থেকেও পাঠানো যায়: status: "Pending Approval"
      };
